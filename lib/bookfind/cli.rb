class Bookfind::CLI
  ...
  def call
    puts "Hello human. I am the Science-fiction Anecdotes Suggestion System or SASS. Are you here to expand your small mamallian brain with fictional accounts of space, time travel and other such lofty concepts? Please just state 'yes' or 'no', we don't want to overcomplicate it for you."
    input = gets.strip
    if input = "yes"
      start 
      elsif input = "no" puts "I see. Please come back when you are feeling more literate."
